  ...
  tagList(
    ...
    tags$div(style="margin:5px",
        ...
        $link.attr('href', curThemePath);
                 ...
                 #             tags$img(src = "www/blt_hex_icon.png", height = "90px"),
                 ...
                 #         span(HTML("Godfree R, Knerr N (2024). Rapid ecological data collection from 360-degree imagery using visualisation and immersive sampling in the R blt package. <i>Methods in Ecology & Evolution, volume:</i>")),
                 #         span("This paper contains a detailed description of the package and associated worked examples."),
                 #         span("or:"),
                 #         span(HTML("Knerr N, Godfree R (2024). <i>blt: Visualisation & Annotation of 360 Degree Imagery.</i> R package version 1.9.1.9000, https://github.com/alexsherlygin/BLT")),
