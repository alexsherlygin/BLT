    ...
    tags$style(
      HTML(
        ".image-panel-title .shinyhelper-wrapper {display: inline-flex; align-items: center; gap: 4px;}
         ...
         .blt-auth-card #auth_login.form-control {padding-right: 46px; appearance: none; -webkit-appearance: none; -moz-appearance: none; background-image: url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 12 8%22 fill=%22none%22%3E%3Cpath d=%22M1 1.5 6 6.5 11 1.5%22 stroke=%22%2360707f%22 stroke-width=%221.8%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22/%3E%3C/svg%3E'); background-repeat: no-repeat; background-position: calc(100% - 18px) center; background-size: 12px 8px;}
