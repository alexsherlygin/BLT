...
seed_dir="${PANNOTATOR_SEED_PROJECT_DIR:-/workspace/resources/seed-project}"
project_dir="${PANNOTATOR_PROJECT_DIR:-/data/project}"
template_path="${PANNOTATOR_PROJECT_SETTINGS_TEMPLATE:-/workspace/infra/docker/config/container-project-settings.yml}"
